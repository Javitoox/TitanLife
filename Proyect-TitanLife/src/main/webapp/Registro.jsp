...
<body>
	...
	<div id="cuadro">
        <form id = "formulario" name="formulario" action="<%= controller %>" method="GET">
            ...
            <input id="Retype" name="Retype" type="password" placeholder="Retype password" maxlength="40" required/><br/>
            <input id="Age"  name="Age" type="text" placeholder="Age" maxlength="40" required/><br/>      
          	<input id="Height"  name="Height" type="text" placeholder="Height (cm)" maxlength="40"required/><br/>
            <input id="Weight"  name="Weight"  type="text" placeholder="Weight (kg)" maxlength="40"required/><br/>
